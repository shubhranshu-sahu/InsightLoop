...
async def test():
    ...
    if "function_call" in final_message.additional_kwargs:
        final_message.additional_kwargs["function_call"]["thought_signature"] = "dummy"
    
    # Try another structure
    if "function_call" not in final_message.additional_kwargs:
        final_message.additional_kwargs["function_call"] = {}
    ...
    try:
        ...
        print("Success with injected thought_signature!")
